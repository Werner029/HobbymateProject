# Generated by Django 5.2.1 on 2025-05-08 01:27
            ...
            fields=[
                ...
                (
                    ...
                    pgvector.django.vector.VectorField(
                        blank=True, dimensions=5, null=True
                    ),
                ),
                (
                    "location",
                ...
                (
                    "interest_vector",
                    pgvector.django.vector.VectorField(dimensions=5),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reason",
                    models.CharField(
                        choices=[("skip", "Пропуск"), ("dislike", "Дизлайк")],
                        max_length=10,
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["user", "reason"],
                        name="users_rejec_user_id_158ae9_idx",
                    )
                ],
